export const CONFIG = Object.freeze({
  ...
  QUALITY: {
    TIERS: {
      HIGH: { particles: 200, gridStep: 2, shadowBlur: 12 },
      MEDIUM: { particles: 100, gridStep: 3, shadowBlur: 6 },
      LOW: { particles: 50, gridStep: 4, shadowBlur: 0 },
    },
  ...
  GRID: { CELL_SIZE: 40, FORCE_DECAY: 0.9, SPRING_CONSTANT: 0.05 },
  PLAYER: {
    BASE_HP: 200, BASE_SPEED: 1.3, ACCELERATION: 0.88,
    DASH: { COOLDOWN: 90, SPEED: 16, INVULN_DURATION: 25 },
    COLLISION_RADIUS: 10,
    INVULN_ON_HIT: 60, 
  },
  WEAPONS: {
    ...
    RAILGUN: { name: "Rail Driver", color: "#00ffff", speed: 30, spread: 0, dmgMult: 2.5, fireDelay: 2, size: 5, pierce: 4, homing: 0, count: 1, lifetime: 100 },
    VOID: { name: "Void Ray", color: "#aa00ff", speed: 12, spread: 0.15, dmgMult: 1.3, fireDelay: 1, size: 8, pierce: 0, homing: 0.25, count: 1, lifetime: 90 },
  } as Record<string, any>,
  ENEMIES: {
    CHASER: { hp: 12, speed: 1.8, size: 15, color: "#ff0055", xp: 10, score: 100, hpScale: 2.5, speedScale: 0.04 },
    SHOOTER: { hp: 10, speed: 1.4, size: 20, color: "#be00ff", xp: 15, score: 150, hpScale: 2.0, speedScale: 0.03, shootInterval: 100 },
    TANK: { hp: 40, speed: 1.0, size: 28, color: "#00ff9d", xp: 25, score: 200, hpScale: 8, speedScale: 0.02 },
    KAMIKAZE: { hp: 8, speed: 3.2, size: 14, color: "#ff5500", xp: 12, score: 120, hpScale: 1.5, speedScale: 0.05, detectRange: 200 },
    TURRET: { hp: 50, speed: 0.4, size: 30, color: "#0088ff", xp: 40, score: 300, hpScale: 10, speedScale: 0, shootInterval: 160 },
    BOSS: { hp: 2500, speed: 1.5, size: 60, color: "#ff3333", xp: 2000, score: 5000, hpScale: 400 },
  } as Record<string, any>,
  // AFFIX CONFIGURATION
  AFFIXES: {
